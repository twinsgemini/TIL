...
truncate table book; -- auto commit > 복구 안됌
...
insert into dept (deptno,dname,loc) values(10, 'EDU', 'SEOUL'); --ERROR
...
-- 'book_pk' 제약조건이름 설정을 통해 오류발생 시 오류 확인 가능
...
-- 제약조건 삭제
-- alter table dept2 frop CONSTRAINT dept2_pk;
